        ...
        "sections": [
            {
                ...
                "topic_contribution": f"界定{topic}的核心问题与研究边界，明确本综述的分析视角",
                "debates": "对该问题的不同定义方式和研究范围划定",
                "target_words": 800,
                "key_clusters": [],
                "key_entities": [],
            },
            {
                ...
                "topic_contribution": f"梳理{topic}领域的主要方法路线及其演化逻辑",
                "debates": "不同方法流派之间的理论假设差异与性能权衡",
                "target_words": 700,
                "key_clusters": [],
                "key_entities": [],
            },
            {
                ...
                "topic_contribution": f"系统分析{topic}各研究方向的关键发现与方法差异",
                "debates": "各方向内部与方向之间的共识与分歧",
                "target_words": 1200,
                "key_clusters": [],
                "key_entities": [],
            },
            {
                ...
                "topic_contribution": f"展示{topic}方法在实际场景中的验证效果与适用边界",
                "debates": "不同评估指标和实验设置下的结论差异",
                "target_words": 500,
                "key_clusters": [],
                "key_entities": [],
            },
            {
                ...
                "topic_contribution": f"指出{topic}领域尚未解决的核心问题与潜在突破方向",
                "debates": "关于最有前景的研究路线的不同判断",
                "target_words": 500,
                "key_clusters": [],
                "key_entities": [],
            },
