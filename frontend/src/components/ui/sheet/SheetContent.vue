  ...
  <DialogPortal>
    ...
    >
      ...
      <DialogClose
        ...
        as-child
      >
        <Button variant="ghost" class="absolute top-2.5 right-2.5 z-10" size="icon-sm">
          <XIcon />
